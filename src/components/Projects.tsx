...
const projects: ProjectData[] = [
  {
    ...
    description:
      'A computer vision-based assistive navigation system that helps visually impaired individuals detect obstacles in their path using real-time video processing and audio alerts.',
    ...
    caseStudy: {
      overview: 'SafeStep was designed to give visually impaired individuals a reliable, real-time sense of their surroundings using lightweight computer vision techniques without requiring expensive specialized hardware.',
      challenge: 'Creating an accessible, low-latency obstacle detection system that runs efficiently on consumer hardware without complex deep learning models, while ensuring the audio feedback is intuitive.',
      solution: 'I built a lightweight computer vision pipeline using OpenCV and HSV color-space thresholding to isolate obstacles in real-time. For feedback, I integrated an offline text-to-speech engine (pyttsx3) that triggers audio alerts and draws bounding boxes when an obstacle enters the user\'s path.',
      architecture: 'Camera Input -> HSV Color Conversion -> Binary Thresholding Mask -> Contour Detection -> pyttsx3 Text-to-Speech Alert Engine.',
      keyFeatures: [
        'Real-time video processing and obstacle highlighting using OpenCV',
        'Robust object detection via optimized HSV color-space thresholding',
        'Offline text-to-speech audio notifications for privacy and speed',
        'Extremely lightweight architecture capable of running on low-end hardware',
      ],
    },
  },
  {
